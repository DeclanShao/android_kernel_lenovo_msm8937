...
#define TP_VENDOR_NAME "AUO"
#define TP_VENDOR_NAME_1 "INX"

#define TP_IC_NAME "HX8529-f65"

#define HIMAX852xf_FINGER_SUPPORT_NUM 10
...
static struct proc_dir_entry *himax_proc_reset_file 		= NULL;
	...
	static int HX_2T2R_en_setting = 0x03;//Need to check with project FW eng.
	...
	uint8_t test_criteria_data[6] = {200,200,200,10,240,10};
#endif
#endif
...
//static int gest_width=0,gest_height=0,gest_mid_x=0,gest_mid_y=0;
	...
	#define HIMAX_PROC_GLOVE_FILE "glove"
	static struct proc_dir_entry *himax_proc_glove_file = NULL;
#endif
